...
for($i=1; $i<37; $i++){
  ...
  $sql = "INSERT INTO st_order SET o_iidx = {$i}, o_midx = 2, o_number = '{$number}', o_tel = '{$tel}', o_email='{$email}', o_addr='{$addr}', o_popt='{$opt}', o_pval='{$val}', o_odate='{$now}', o_pmidx={$i}";
  // sql_exec($sql);
  // sleep(rand(1,3));
